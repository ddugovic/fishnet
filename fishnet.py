...
def go(conf, p, variant, position, moves, movetime=None, clock=None, depth=None, nodes=None):
...
def main(argv):
    ...
    g.add_argument("--watkins-fixed-backoff", action="store_true", default=None, help="watkins fixed backoff (only recommended for move servers)")
    g.add_argument("--no-watkins-fixed-backoff", dest="watkins_fixed_backoff", action="store_false", default=None)
